 ...
 const navItems: NavItem[] = [
   ...
   { label: 'Candidaturas', href: '/admin/candidaturas', icon: Users },
     ...
     <>
       ...
       <div className="lg:hidden fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between border-b border-border bg-card px-4">
         <Link to="/admin" className="flex items-center gap-2">
           ...
           <span className="font-bold text-foreground">JobCV Admin</span>
         </Link>
       ...
       {/* Mobile Menu */}
       {!collapsed && (
         <div className="lg:hidden fixed inset-0 z-40 bg-background/80 backdrop-blur-sm" onClick={() => setCollapsed(true)} />
       )}
             ...
             {!collapsed && (
               <Link to="/admin" className="flex items-center gap-2">
                 ...
                 <div className="flex flex-col">
                   ...
                   <span className="text-[10px] text-muted-foreground">Backoffice</span>
                 </div>
               </Link>
             )}
             {collapsed && (
